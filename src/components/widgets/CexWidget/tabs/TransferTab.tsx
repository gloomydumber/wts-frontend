  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1, flex: 1 }}>
      <Box sx={{ display: 'flex', gap: 1 }}>
        <Box sx={{ flex: 1 }}>
          <Typography sx={{ fontSize: '0.6rem', color: 'text.secondary', mb: 0.5 }}>From</Typography>
      ...
      {showIsolatedSection && (
        <Box>
          <Typography sx={{ fontSize: '0.6rem', color: 'text.secondary', mb: 0.5 }}>Isolated Pair</Typography>
          <Select
            value={isolatedPair}
      ...
      {showIsolatedSection && (
        <Box sx={{ border: 1, borderColor: 'divider', borderRadius: 1, p: 1 }}>
          <Typography sx={{ fontSize: '0.6rem', color: 'text.secondary', mb: 0.5, textTransform: 'uppercase' }}>
           ...
           */}
          <Typography sx={{ fontSize: '0.5rem', color: 'text.disabled', mt: 0.5 }}>
